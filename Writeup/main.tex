...
\fancyhead[R]{\textit{RIT Computer Science ~\textbullet~ Capstone Report ~\textbullet~ 2185}}
...
\newcommand\mainmsg[1]{\textcolor{blue}{MainMsg: #1}}
\newcommand\msg[1]{\textcolor{gray}{Msg: #1}}
...
\title{RIT CS Capstone project template}
